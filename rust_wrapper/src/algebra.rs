...
pub extern "C" fn CscMatrix_new(
    ...
    let rowval_vec = unsafe { Vec::from_raw_parts(rowval as *mut usize, num_of_nzvalues, num_of_nzvalues) };
    let nzval_vec = unsafe { Vec::from_raw_parts(nzval as *mut f64, num_of_nzvalues, num_of_nzvalues) };
